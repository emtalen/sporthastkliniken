  ...
  return (
    <div>
      <div className="service-row">
        <div
          className="service"
          style={{ backgroundImage: 'url("/images/10_endoskopi-min.jpg")' }}
        ...
        <div
          className="service"
          style={{ backgroundImage: 'url("/images/5_med under-min.jpg")' }}
        ...
        <div
          className="service"
          style={{ backgroundImage: 'url("/images/11_tand-min.jpg")' }}
