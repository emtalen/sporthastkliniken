  ...
  return (
    <div id="last-row">
      <div className="service-row">
        <div
          className="service"
          style={{ backgroundImage: 'url("/images/12_hov-min.jpg")' }}
        ...
        <div
          className="service"
          style={{ backgroundImage: 'url("/images/13_rehab-min.jpg")' }}
        ...
        <div
          className="service"
          style={{ backgroundImage: 'url("/images/15_forelasning-min.jpg")' }}
